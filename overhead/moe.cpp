...
#define DEBUG_LEVEL 0 // 0: MoE, 1: PPNT, 2+: Misc
...
#define PPNT_PROFILE_ATTENTION2 1
#define PPNT_PROFILE_SCATTER    1 //
#define PPNT_PROFILE_FFN1       1 //
#define PPNT_PROFILE_RELU       1        
#define PPNT_PROFILE_FFN2       1
...
int main(int argc, char **argv) {
    ...
    // for overhead profiling
    printf("[PPNT] target fn disabled\n");
    ...
    // for logging profile iterations
    cout << "K1 profile iters: " << k1_profile_iters << "\n";
    cout << "K2 profile iters: " << k2_profile_iters << "\n";
    ...
    // for entire overhead profiling
    auto end_setup = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double> elapsed_setup = end_setup - start;
    std::cout << "Elapsed setup time: " << elapsed_setup.count() << " s" << std::endl;
    ...
    {
#if 0 // disabled for overhead profiling
        // Allocation
    ...
    // for warmup overhead profiling
    auto end_warmup = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double> elapsed_warmup = end_warmup - start;
    std::cout << "Elapsed warmup time: " << elapsed_warmup.count() << " s" << std::endl;
    ...
    std::chrono::duration<double> elapsed_program = end_program - start;
    std::cout << "Elapsed prg time: " << elapsed_program.count() << " s" << std::endl;
