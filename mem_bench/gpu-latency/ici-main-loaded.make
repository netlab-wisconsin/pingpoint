...
$(BIN_DIR)/$(PREFIX)-$(NAME)-$(SUFFIX)-cc0: ici-main-loaded.cpp 
	$(CC) $(OPTS) $(CCFLAGS) $(INCLUDES) $(LDFLAGS) -DPINNED_CC=0 -o $@ $<

$(BIN_DIR)/$(PREFIX)-$(NAME)-$(SUFFIX)-cc1: ici-main-loaded.cpp 
	$(CC) $(OPTS) $(CCFLAGS) $(INCLUDES) $(LDFLAGS) -DPINNED_CC=1 -o $@ $<

$(BIN_DIR)/$(PREFIX)-$(NAME)-$(SUFFIX)-cc2: ici-main-loaded.cpp 
	$(CC) $(OPTS) $(CCFLAGS) $(INCLUDES) $(LDFLAGS) -DPINNED_CC=2 -o $@ $<

$(BIN_DIR)/$(PREFIX)-$(NAME)-$(SUFFIX)-cc3: ici-main-loaded.cpp 
	$(CC) $(OPTS) $(CCFLAGS) $(INCLUDES) $(LDFLAGS) -DPINNED_CC=3 -o $@ $<

$(BIN_DIR)/$(PREFIX)-$(NAME)-$(SUFFIX)-ccall: main-loaded.hip 
