...
HIP_VISIBLE_DEVICES=2 ../bin/acn-main-hop2-${ARCH}-${SUFFIX} 2>&1 | tee ../results-loaded-lat/acn-main-hop2-${ARCH}-${SUFFIX}.out &
HIP_VISIBLE_DEVICES=3 ../bin/acn-main-hop3-${ARCH}-${SUFFIX} 2>&1 | tee ../results-loaded-lat/acn-main-hop3-${ARCH}-${SUFFIX}.out &
...
HIP_VISIBLE_DEVICES=6 ../bin/acn-main-hop2-${ARCH}-${SUFFIX} 2>&1 | tee ../results-loaded-lat/acn-main-hop2-${ARCH}-${SUFFIX}.out &
HIP_VISIBLE_DEVICES=7 ../bin/acn-main-hop3-${ARCH}-${SUFFIX} 2>&1 | tee ../results-loaded-lat/acn-main-hop3-${ARCH}-${SUFFIX}.out &
