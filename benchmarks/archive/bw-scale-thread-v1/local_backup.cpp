/*
 * This file is a backup copy of the original local.cpp file. (12/29/25)
 * I was trying something with this but forgot. Leaving just in case of later reuse.
 */
...
int main() {
    ...
    printf("data_size: %lld MB, chunk_size: %d KB\n", data_size / (1024 * 1024), CHUNK_SIZE / 1024);
