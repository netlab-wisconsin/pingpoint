...
__global__ void k(
    ...
    T *__restrict__ k1_dummy_buf, const int64_t k1_N, uint64_t *k1_startClk, uint64_t *k1_stopClk,
    /* k2 args */
    ...
    size_t *k2_chunks_size, const size_t k2_chunk_size, const uint32_t k2_xcd, const uint32_t k2_hbm, const uint32_t k2_tpb, 
    const int64_t k2_N, uint64_t *k2_startClk, uint64_t *k2_stopClk)
{
