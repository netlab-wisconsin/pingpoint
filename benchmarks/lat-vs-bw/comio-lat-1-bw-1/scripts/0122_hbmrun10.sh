...
./bin/lat_xcd_${K1_PINNED_XCD}_hbm_${K1_PINNED_HBM}_bw_xcd_${K2_PINNED_XCD}_hbm_${K2_PINNED_HBM}_bpx_1_80_${SUFFIX}_128 |& tee /work1/sinclair/junyeol/ici-workspace/sigcomm-exp/3.6-lat-vs-bw/raw/lat_xcd_${K1_PINNED_XCD}_hbm_${K1_PINNED_HBM}_bw_xcd_${K2_PINNED_XCD}_hbm_${K2_PINNED_HBM}_bpx_1_80_${SUFFIX}_128.out